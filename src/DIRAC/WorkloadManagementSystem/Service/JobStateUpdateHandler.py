...
class JobStateUpdateHandlerMixin:
    ...
    def export_updateJobFromStager(cls, jobID, status):
        ...
        result = JobStatusUtility(cls.jobDB, cls.jobLoggingDB, cls.elasticJobParametersDB).setJobStatus(
    ...
    def export_setJobStatus(cls, jobID, status="", minorStatus="", source="Unknown", datetime=None, force=False):
        ...
        """
        return JobStatusUtility(cls.jobDB, cls.jobLoggingDB, cls.elasticJobParametersDB).setJobStatus(
    ...
    def export_setJobStatusBulk(cls, jobID, statusDict, force=False):
        ...
        return JobStatusUtility(cls.jobDB, cls.jobLoggingDB, cls.elasticJobParametersDB).setJobStatusBulk(
            int(jobID), statusDict, force=force
        )
    ...
    def export_setJobApplicationStatus(cls, jobID, appStatus, source="Unknown"):
        ...
        """
        return JobStatusUtility(cls.jobDB, cls.jobLoggingDB, cls.elasticJobParametersDB).setJobStatus(
            jobID, appStatus=appStatus, source=source
        )
